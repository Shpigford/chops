...
- Keep the app icon sourced from `Chops/Resources/Assets.xcassets/ChopsAppIcon.appiconset` and keep `ASSETCATALOG_COMPILER_APPICON_NAME`, `CFBundleIconFile`, and `CFBundleIconName` aligned with that name.
