...
## Scope
- This file governs `FastTalk/Views/Detail/`.
...
- Reuse `FastTalkTextView` when editing behavior requires native cursor, find-panel, insertion-point, or markdown-formatting support.
