...
- Keep subsystem settings narrow:
  ...
  - about tab for app metadata and private distribution links
...
- Keep diagnostics export, remote connection testing, and assistant template editing attached to the settings scene rather than leaking them into unrelated workflows.
