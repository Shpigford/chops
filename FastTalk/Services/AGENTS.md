...
## Scope
- This file governs `FastTalk/Services/`.
...
- Never add new tool-scan roots in ad hoc service code when they belong in `ToolSource`, `AgentTarget`, or `FastTalkSettings`.
